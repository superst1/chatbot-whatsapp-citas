...
export async function createAppointment(data) {
  ...
  try {
    ...
    const response = await sheets.spreadsheets.values.append({
      ...
      range: "Citas!A:H", // Ajusta el rango a tu hoja
    ...
    // Si quieres devolver un número de cita incremental:
...
export async function findAppointmentById(id) {
  ...
  try {
    ...
    // Asumiendo que el número de cita está en la primera columna (A)
